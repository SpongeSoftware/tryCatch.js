 ...
 * ```
 */
export declare const tryCatch: <T = unknown, E = Error>(promise: Promise<T>) => Promise<Result<T, E>>;
/**
 ...
 * ```
 */
export declare const tryCatchSync: <T = unknown, E = Error>(callback: () => T) => Result<T, E>;
export {};
